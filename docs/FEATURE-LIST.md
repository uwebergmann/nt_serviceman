...
| 3 | NetBox Initial-Import | 1–2 Tage | – |
...
### 3. NetBox Initial-Import

**Quelle:** Pflichtenheft – Erledigte und offene Punkte

Alle CI aus NetBox holen und in Odoo anlegen. Alle Devices aus NetBox (z. B. `/api/dcim/devices/`) abrufen und als CI in Odoo anlegen. Button oder Aktion in Konfiguration.
